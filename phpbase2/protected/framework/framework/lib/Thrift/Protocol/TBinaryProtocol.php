...
class TBinaryProtocol extends TProtocol {
  ...
  public function writeFieldEnd() {
    $this->outputArgs[$this->_fieldName] = $this->_fieldValue;
    return 0;
  }
  ...
  public function readMessageEnd() {
      $transport = $this->trans_->transport_;
      $url = "tcp://{$transport->host_}:{$transport->port_}";
      \CallLog::logModuleCall("thrift", $url, $this->outputArgs, json_encode($this->inputArgs), $this->_startTime);
    return 0;
  }
  ...
  public function readFieldEnd() {
      $this->inputArgs[] = $this->_fieldValue;
    return 0;
  }
