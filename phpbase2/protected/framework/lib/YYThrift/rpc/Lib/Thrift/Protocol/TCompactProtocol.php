...
class TCompactProtocol extends TProtocol {
  ...
  public function readFieldBegin(&$name, &$field_type, &$field_id) {
    ...
    //bug: PHP TCompactProtocol always reads bools as false, https://issues.apache.org/jira/browse/THRIFT-1548
    //fix: $field_type should be compared to COMPACT_TRUE or COMPACT_FALSE before being converted to a TType. 
    //     Otherwise, $field_type will be converted to TType::BOOL (0x02) and will always match COMPACT_FALSE (0x02).
