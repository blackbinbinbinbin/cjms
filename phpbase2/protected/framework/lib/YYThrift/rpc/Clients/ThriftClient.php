...
require_once LIBS_PATH . '/YYThrift/rpc/Lib/Thrift/ClassLoader/ThriftClassLoader.php';
require_once 'AddressManager.php';

$loader = new \Thrift\ClassLoader\ThriftClassLoader();
//$loader->registerNamespace('Thrift', THRIFT_CLIENT. '/../Lib');
$loader->registerNamespace('Thrift', LIBS_PATH . '/YYThrift/rpc/Lib');
$loader->register();
...
class ThriftInstance
{
    ...
    protected function __instance()
    {
        ...
        // Transport
        require_once LIBS_PATH . "/YYThrift/rpc/Lib/Thrift/Transport/TSocket.php";
        require_once LIBS_PATH . "/YYThrift/rpc/Lib/Thrift/Transport/TTransport.php";
        //require_once LIBS_PATH . "/thrift/rpc/Lib/Thrift/Transport/TSocket.php";
