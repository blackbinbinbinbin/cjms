...
(function (global) {
     ...
     */
    var template = function template(id, content) {
    ...
    var _compile = (function () {
        ...
        var getVariable = function getVariable(code) {
    ...
    /**
     * 格式化显示价格
     * @param  {[type]} value [价格，单位分]
     */
    template.helper('priceFormat', function (value) {
        var price = parseFloat(value) / 100;
        return price.toFixed(2);
    });

    template.helper('suffix', function (type) {
        var multiple = 1;
        ...
        return {
            full: '?imageview/2/w/' + 320 * multiple,
            cont: '?imageview/2/w/' + 160 * multiple
        };
    });
})(this);