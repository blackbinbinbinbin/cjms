<?php
//常量
defined('REDIS_PRE_KEY_RANDOM_ID') || define_2('REDIS_PRE_KEY_RANDOM_ID', 'genRandomId:');
...
if (!isset($GLOBALS['r2mConf']['ka_1'])) { $GLOBALS['r2mConf']['ka_1'] = []; }
$GLOBALS['r2mConf']['ka_1'] += array (
  'host' => '61.160.36.225',
  'port' => '9501',
  'pwd' => 'test',
);
...
if (!isset($GLOBALS['r2mInfo']['dw_shop']['user_coupons_test'])) { $GLOBALS['r2mInfo']['dw_shop']['user_coupons_test'] = []; }
$GLOBALS['r2mInfo']['dw_shop']['user_coupons_test'] += array (
  'key' => 'id',
  'ttl' => '86400',
);
